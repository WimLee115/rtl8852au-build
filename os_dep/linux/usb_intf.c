...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDOR_ID_DLINK, 0x332c, 0xff, 0xff, 0xff), .driver_info = RTL8852A}, /* D-Link DWA-1850 */
	...
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDOR_ID_TPLINK, 0x012e, 0xff, 0xff, 0xff), .driver_info = RTL8852A}, /* TP-Link Archer TX20U */
